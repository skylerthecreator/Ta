...
"I guess I shall reintroduce myself. My name is Maurice. My objective is to preserve peace across Vatereo, the name of our world.",
...
"Until then, I have left my amulet just on that table. Take it, as it will provide you with a layer of great protection."]
